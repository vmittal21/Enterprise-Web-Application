...
public class FitnessWatchList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
		   if(CategoryName.equals("outad"))
		   {
		   ...
		   else if(CategoryName.equals("buture"))
		    {
			for(Map.Entry<String,FitnessWatch> entry : SaxParserDataStore.fitnessWatches.entrySet())
				{
				 if(entry.getValue().getRetailer().equals("Buture"))
				 {
					 hm.put(entry.getValue().getId(),entry.getValue());
				 }
				}
			...
			else if(CategoryName.equals("sycyka"))
			{
				for(Map.Entry<String,FitnessWatch> entry : SaxParserDataStore.fitnessWatches.entrySet())
				{
				 if(entry.getValue().getRetailer().equals("SYCYKA"))
				 {
					 hm.put(entry.getValue().getId(),entry.getValue());
				 }
				}
			...
			else if(CategoryName.equals("odfit"))
			{
				for(Map.Entry<String,FitnessWatch> entry : SaxParserDataStore.fitnessWatches.entrySet())
				{
				 if(entry.getValue().getRetailer().equals("Odfit"))
				 {
					 hm.put(entry.getValue().getId(),entry.getValue());
				 }
				}
			...
			else if(CategoryName.equals("kungix"))
			{
				for(Map.Entry<String,FitnessWatch> entry : SaxParserDataStore.fitnessWatches.entrySet())
				{
				 if(entry.getValue().getRetailer().equals("Kungix"))
				 {
					 hm.put(entry.getValue().getId(),entry.getValue());
				 }
				}
		...
		for(Map.Entry<String, FitnessWatch> entry : hm.entrySet())
		{
			...
			System.out.println("+++++++++++++++++++++++++++++++++++"+fitnessWatch.getName());
