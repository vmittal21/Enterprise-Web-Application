...
public class SalesReport extends HttpServlet {
    ...
    private void displaySalesReport(HttpServletRequest request,
        ...
        pw.print("<tr>");
        pw.print("<td><h4>Product Name</h4></td>");
        pw.print("<td><h4>Price</h4></td>");
        pw.print("<td><h4>Number of Items Sold</h4></td>");
        pw.print("</tr>");
        ...
        for (OrderPayment orderPayment : orderPaymentHashMap.values()) {
            ...
            total_items_sold += orderPayment.getSaleAmount();
            pw.print("<tr>");
        ...
        pw.print("<table class='gridtable'>");
        pw.print("<tr>");
        pw.print("<td><h3> Total Sales of Every Product Sold</h3></td>");
        pw.print("<td>"+total_items_sold+"</td>");
        pw.print("</tr>");
        pw.print("</table>");
        ...
        pw.print("<table class='gridtable'>");
        pw.print("<tr>");
        pw.print("<td><h4>Date</h4></td>");
        pw.print("<td><h4>Sold Amount</h4></td>");
        pw.print("</tr>");
        ...
        System.out.println(orderPaymentHashMap.size());
        for (OrderPayment orderPayment : orderPaymentHashMap.values()) {
            System.out.println(orderPayment.getpurchasedate());
            // String purchasedate = orderPayment.getpurchasedate().toString().substring(0, 10);
            // System.out.println(purchasedate);
            if (orderPayment.getSaleAmount() > 0){
            pw.print("<tr>");
            pw.print("<td>" + orderPayment.getpurchasedate() + "</td>" +
                    "<td>" + orderPayment.getSaleAmount() + "</td>");
            pw.print("</tr>");
            }
