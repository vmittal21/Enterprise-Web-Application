	...
	protected void doGet(HttpServletRequest request,
		...
		if(action.equals("Addproduct"))
		{
			...
			pw.print("<form method='get' action='ProductCrud'>"
					...
					+ "<h3>Product Type</h3></td><td><select name='producttype' class='input'><option value='headphones' selected>Head Phone</option><option value='voiceAssistants' selected>Voice Assistant</option><option value='petTrackers' selected>Pet Tracker</option><option value='fitnessWatches' selected>Fitness Watch</option><option value='smartWatches' selected>Smart Watch</option><option value='laptops' selected>Laptop</option><option value='consoles' selected>TV</option><option value='tablets' selected>Phone</option><option value='soundSystems'>Sound Systems</option><option value='virtualRealities'>Virtual Reality</option><option value='accessories'>Accessory</option></select>"
					+ "</td></tr><tr><td>"
