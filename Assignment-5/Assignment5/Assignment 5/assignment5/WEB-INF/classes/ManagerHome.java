...
public class ManagerHome extends HttpServlet {
	...
	protected void displayLogin(HttpServletRequest request,
		...
		pw.print("<form method='get' action='ProductModify'>"
				...
				+ "<input type='submit' class='btnbuy' name='button' value='Add Product'style = 'font-size:50px'></input>"
				+ "</td></tr><tr><td></td></tr><tr><td>"
				+ "<input type='submit' class='btnbuy' name='button' value='Update Product' style = 'font-size:50px'></input>"
				+ "</td></tr><tr><td></td></tr><tr><td>"
				+ "<input type='submit' class='btnbuy' name='button' value='Delete Product' style = 'font-size:50px'></input>"
				+ "</td></tr><tr><td></td></tr><tr><td>"
