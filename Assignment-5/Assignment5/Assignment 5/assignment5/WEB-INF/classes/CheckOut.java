...
public class CheckOut extends HttpServlet {
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String access = request.getParameter("type");
		
		storeOrders(request, response, access);
	}
	
	protected void storeOrders(HttpServletRequest request, HttpServletResponse response, String access) throws ServletException, IOException {
	    try
        {
        response.setContentType("text/html");
		PrintWriter pw = response.getWriter();
		...
		pw.print("</td></tr>");
		pw.print("<tr><td>");
     	pw.print("Purchasedate</td>");
		pw.print("<td><input type='text' name='purchasedate'>");
		pw.print("</td></tr>");
		pw.print("<tr><td>");
     	pw.print("shipdate</td>");
		pw.print("<td><input type='text' name='shipdate'>");
		pw.print("</td></tr>");
		pw.print("<tr><td>");
		pw.print("shipping cost?</td>");
		pw.print("<br><td><select size=1>");
        pw.print("<option value='standard'>standard, 5$</option>");
        pw.print("<option value='fast'>fast, 10$</option>");
        pw.print("</select>");
		pw.print("</td></tr>");
		pw.print("<tr><td>");
     	pw.print("category</td>");
		pw.print("<td><input type='text' name='category'>");
				pw.print("</td></tr>");
				pw.print("<tr><td>");
     	pw.print("quantity</td>");
		pw.print("<td><input type='text' name='quantity'>");
				pw.print("</td></tr>");
				pw.print("<tr><td>");
     	pw.print("discount</td>");
		pw.print("<td><input type='text' name='discount'>");
				pw.print("</td></tr>");
		pw.print("<tr><td>");
        ...
        pw.print("</td></tr>");
		pw.print("<tr><td>");
		pw.print("Delivery Type: "+access+"</td>");


		if (access.equals("storepickup")){
		pw.print("</select>");
		pw.print("</td></tr>");
		pw.print("<tr><td>");
