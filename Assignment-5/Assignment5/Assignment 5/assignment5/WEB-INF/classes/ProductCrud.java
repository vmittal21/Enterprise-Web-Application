	...
	protected void doGet(HttpServletRequest request,
			...
			if(action.equals("add"))
			{
			  ...
			  {  
				  try
				  {
					  msg = MySqlDataStoreUtilities.addproducts(producttype,productId,productName,productPrice,productImage,productManufacturer,productCondition,productDiscount,prod,Inventory);
				  }
				  catch(Exception e)
				  { 
			...
			}else if(action.equals("update"))
			{
			  ...
			  {		
				  ...
				  try
				  {
					msg = MySqlDataStoreUtilities.updateproducts(producttype,productId,productName,productPrice,productImage,productManufacturer,productCondition,productDiscount,Inventory);
				  }
				  catch(Exception e)
				  { 
